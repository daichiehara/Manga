  ...
  return (
    <>
      ...
      <Box sx={{ pt: '4rem' }}>
        ...
        {/* コメント入力 */}
        <Box sx={{ position: 'fixed', bottom: 0, width: '100%',maxWidth: '640px', px: '0.7rem', py: '0.5rem', bgcolor: 'background.paper', justifyContent: 'center', alignItems: 'center',boxSizing: 'border-box', pb: 2 }}>
          {isAuthenticated ? (
