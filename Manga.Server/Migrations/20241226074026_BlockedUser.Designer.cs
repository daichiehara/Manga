...
namespace Manga.Server.Migrations
{
    ...
    [Migration("20241226074026_BlockedUser")]
    partial class BlockedUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Manga.Server.Models.BlockedUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Manga.Server.Models.Sell", b =>
                {
                    ...
                    b.Property<int>("DeletedRequestCount")
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("UnifiedSearchText")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Manga.Server.Models.BlockedUser", b =>
                {
                    b.HasOne("Manga.Server.Models.UserAccount", "Blocked")
                        .WithMany("BlockedByUsers")
                        .HasForeignKey("BlockedId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Manga.Server.Models.UserAccount", "Blocker")
            ...
            modelBuilder.Entity("Manga.Server.Models.Report", b =>
                {
                    b.HasOne("Manga.Server.Models.Reply", "Reply")
                        .WithMany("Reports")
