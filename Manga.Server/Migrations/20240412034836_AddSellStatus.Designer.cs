...
namespace Manga.Server.Migrations
{
    ...
    [Migration("20240412034836_AddSellStatus")]
    partial class AddSellStatus
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Manga.Server.Models.Match", b =>
                {
                    ...
                    b.Property<int>("FirstRequestId")
                        .HasColumnType("integer");

                    b.Property<int>("SecondRequestId")
                        .HasColumnType("integer");

                    b.HasKey("MatchId");

                    b.HasIndex("FirstRequestId");

                    b.HasIndex("SecondRequestId");
            ...
            modelBuilder.Entity("Manga.Server.Models.Match", b =>
                {
                    b.HasOne("Manga.Server.Models.Request", "FirstRequest")
                        .WithMany()
                        .HasForeignKey("FirstRequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Manga.Server.Models.Request", "SecondRequest")
                        .WithMany()
                        .HasForeignKey("SecondRequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("FirstRequest");

                    b.Navigation("SecondRequest");
                });
