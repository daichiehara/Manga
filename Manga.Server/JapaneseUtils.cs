namespace Manga.Server
{
        ...
        private static readonly Dictionary<char, char> HiraganaToKatakanaMap = new Dictionary<char, char>
    {
        ...
        {'な', 'ナ'}, {'に', 'ニ'}, {'ぬ', 'ヌ'}, {'ね', 'ネ'}, {'の', 'ノ'},
        {'は', 'ハ'}, {'ば', 'バ'}, {'ぱ', 'パ'}, {'ひ', 'ヒ'}, {'び', 'ビ'}, {'ぴ', 'ピ'}, {'ふ', 'フ'}, {'ぶ', 'ブ'}, {'ぷ', 'プ'},
        {'へ', 'ヘ'}, {'べ', 'ベ'}, {'ぺ', 'ペ'}, {'ほ', 'ホ'}, {'ぼ', 'ボ'}, {'ぽ', 'ポ'},
        {'ま', 'マ'}, {'み', 'ミ'}, {'む', 'ム'}, {'め', 'メ'}, {'も', 'モ'},
        {'ゃ', 'ャ'}, {'や', 'ヤ'}, {'ゅ', 'ュ'}, {'ゆ', 'ユ'}, {'ょ', 'ョ'}, {'よ', 'ヨ'},
        {'ら', 'ラ'}, {'り', 'リ'}, {'る', 'ル'}, {'れ', 'レ'}, {'ろ', 'ロ'},
        {'ゎ', 'ヮ'}, {'わ', 'ワ'}, {'ゐ', 'ヰ'}, {'ゑ', 'ヱ'}, {'を', 'ヲ'}, {'ん', 'ン'},
        {'ゔ', 'ヴ'}
    };

        public static string HiraganaToKatakana(string input)
        {
            return new string(input.Select(c => HiraganaToKatakanaMap.TryGetValue(c, out char katakana) ? katakana : c).ToArray());
        }
    }
}
